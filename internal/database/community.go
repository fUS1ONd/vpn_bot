...
// Таблица community_members — знания бота о Канале. Их ровно два: заявка
// пользователя одобрена («в Канале») и когда ему в последний раз показывали
// приписку про Канал.
//
...
// IsCommunityMember сообщает, одобрял ли бот заявку этого пользователя.
// Выход из Канала пометку не снимает: человек уже узнал о сообществе.
