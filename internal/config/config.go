...
type Config struct {
	...
	// AutorenewEnabled гасит всё сразу: абзац согласия, save_payment_method,
	// кнопки и шаг scheduler. Выключено по умолчанию — код выкатывается раньше,
	// чем касса одобрит рекурренты.
	AutorenewEnabled bool
}

// AutorenewingEnabled — включено ли автопродление. Одного флага мало:
// автосписание возможно только через ЮKassa, по криптоплатежу не списать.
...
// getEnvBool: всё, кроме явного «включено», выключает функцию.
