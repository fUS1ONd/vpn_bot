...
Введите код приглашения:`
	...
	MsgPreviewWelcome = `<b>👀 Preview-режим</b>

Вы находитесь в preview-режиме и можете посмотреть интерфейс бота без активации VPN.

Чтобы получить доступ к VPN, нажмите «🎟 Активировать код» и введите инвайт.`
...
Отправьте /start для регистрации.`
	...
	MsgPreviewStatus = `<b>👤 Preview-режим</b>

VPN ещё не активирован.

Вы находитесь в preview-режиме.

Нажмите «🎟 Активировать код», чтобы получить доступ после ввода инвайта.`
...
Скопируйте ссылку и вставьте в приложение VPN-клиента.`
	...
	MsgPreviewConnect = `<b>🌐 Preview-режим</b>

Реальная ссылка для подключения недоступна в preview-режиме.

Ссылка появится после активации инвайта.`
...
const PreviewSubscriptionPlaceholder = `Ссылка появится после активации инвайта`
