...
24. **Автопродление подписки.** Включается рубильником `AUTORENEW_ENABLED` **вместе** с
...
- **Автопродление: согласие и Способ**: `docs/adr/0003-autorenewal-consent-and-method.md` — почему согласие и Способ автосписания разведены на две сущности и почему Способ берётся из обычной оплаты, а не отдельной привязкой
